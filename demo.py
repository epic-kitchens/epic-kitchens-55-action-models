...
from model_loader import make_model, load_checkpoint

parser = argparse.ArgumentParser(
    description='Test the instantiation of models',
...
parser.add_argument('--tsm-shift-place', default='blockres', choices=['block', 'blockres'])
...
def extract_settings_from_args(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    for variant in ['trn', 'tsm', 'tsn']:
        ...
        variant_keys = {key for key in settings.keys() if key.startswith(variant_key_prefix)}
